...
class VocabHelp(object):
    def __init__(self, counter, specials=['<pad>', '<unk>']):
        ...
        for tok in specials:
            del counter[tok] #Counter{<pad>:1, <unk>:1}
...
def parse_args(data_name):
    ...
    parser.add_argument('--data_dir', default=f'J:\dataset_\{data_name}_corenlp',help='TACRED directory.') #dataset path
    parser.add_argument('--vocab_dir', default=f'J:\dataset_\{data_name}_corenlp', help='Output vocab directory.')
